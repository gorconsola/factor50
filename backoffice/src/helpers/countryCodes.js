export const COUNTRIES = [
  ...
  { value: 'AG', label: 'Antigua and/or Barbuda' },
  ...
  { value: 'IO', label: 'British lndian Ocean Territory' },
  ...
  { value: 'AN', label: 'Nederlandse Antillen' },
  ...
  { value: 'SJ', label: 'Svalbarn and Jan Mayen Islands' },
  ...
  { value: 'VG', label: 'Virigan Islands (British)' },
